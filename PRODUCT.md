...
Devialet 式歐洲高端 B2B 工業美學：深色大面積留白、精準的橙色點綴、緊湊大寫標題。情緒目標是「信心」與「專業敬意」——買家看完應該覺得「這是一家和 DIENES 同級的工程公司」，而不是「這是一家便宜的亞洲供應商」。

視覺參考（docs/competitor-research.md）：

- **Helios Slitting**（視覺方向）：全黑 Hero + 3D 產品渲染 + 浮動 CTA
- **Mario Cotta**（內容架構）：應用場景分類 + 產品 Tab
- **DIENES**（服務生態）：切法說明 + 服務體系
...
5. **歐洲級外觀、台灣式坦率**：視覺品質對標 DIENES/Helios，論述誠實直接（歐洲品質的 70% 價格），不裝腔也不廉價
