...
const APPLICATIONS = [
  { path: "/applications/plastic-film", name: "Plastic Film" },
  { path: "/applications/metallic-foil", name: "Metallic Foil" },
  { path: "/applications/rubber", name: "Rubber" },
  { path: "/applications/paper", name: "Paper" },
  { path: "/applications/nonwoven", name: "Nonwoven" },
] as const;
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <h2 className="mt-2 text-3xl font-bold text-text-primary md:text-4xl">
                35 Years of Precision Manufacturing
              </h2>
